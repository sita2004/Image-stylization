...
def show_n(images, titles=('',), col=st):
    for i, image in enumerate(images):
        col.image(np.array(image[0]), caption=titles[i], use_column_width=True)

# Page configuration
st.set_page_config(page_title="Image Stylization App", page_icon="🎨", layout="wide", initial_sidebar_state="expanded")
...
# App Layout
st.markdown('## Image Stylization Application')
